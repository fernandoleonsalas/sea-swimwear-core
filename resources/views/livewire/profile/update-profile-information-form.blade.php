...
new class extends Component
{
    ...
    public function updateProfileInformation(): void
    {
        ...
        $validated = $this->validate([
            ...
            'email' => ['required', 'string', 'lowercase', 'email', 'max:255', 'email:rfc,dns', Rule::unique(User::class)->ignore($user->id)],
        ]);
...
<section>
    ...
    <form wire:submit="updateProfileInformation" class="mt-6 space-y-6">
        <div>
            ...
            <x-text-input wire:model="name" id="name" name="name" type="text" class="mt-1 block w-full capitalize" required autofocus autocomplete="name" />
