...
<div>
    <div class="mb-4 text-sm text-gray-700 text-justify">
    ...
    <form wire:submit="sendPasswordResetLink">
        ...
        <div class="flex items-center justify-end mt-4">
            {{-- BOTÓN PARA ENVIAR EL CODIGO PARA RESTABLECER LA CONTRASEÑA --}}
            <x-primary-button class="ms-3" wire:loading.attr="disabled" wire:target="restablcer">
