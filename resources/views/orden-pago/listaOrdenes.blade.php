<!-- Está es la Vista  del listado de ordenes de pago -->
<!-- Utiliza el componente o plantilla breeze y Utiliza el componente Livewire -->
<x-app-layout title="Lista De Ordenes-Pago">
    <div class="pt-2 pb-8 bg-gray-200">
        <x-slot name="header">
            <h2 class="font-semibold text-2xl text-black  leading-tight flex items-center ">
